...
def main():
    ...
    ################ add tcp   
    elif args_cli.teleop_device.lower() == "tcp":
        from scripts.environments.teleoperation.tcp_teleop import QuestVRTeleop
        teleop_interface = QuestVRTeleop(ip="0.0.0.0", port=5006)
